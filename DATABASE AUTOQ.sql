...
CREATE TABLE dim_pecas (
SK_PECAS int NOT NULL AUTO_INCREMENT,
NM_PECAS varchar(450) DEFAULT NULL,
DS_CATEGORIA varchar(450) DEFAULT NULL,
VLR_CUSTO varchar(450) DEFAULT NULL,
VLR_VENDA varchar(450) DEFAULT NULL,
DS_LOCALIZACAO varchar(450) DEFAULT NULL,
UND_MEDIDA varchar(450) DEFAULT NULL,
CREATED_AT timestamp NULL DEFAULT CURRENT_TIMESTAMP,
UPDATE_AT timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
D_E_L_E_T char(1) DEFAULT NULL
PRIMARY KEY (SK_PECAS));